        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="mb-4">
            ...
            <p className="text-gray-600 text-sm">
              This is a demo simulation of how the AI agent would interact with an influencer. 
              You can speak as the influencer to test the conversation flow.
            </p>
          </div>
          
          <div className="border rounded-lg bg-gray-50 p-4" style={{ minHeight: '600px' }}>
            <div 
              ref={conversationRef} 
